...
RailwaySystem::RailwaySystem() : positionA(0), positionB(0), sharedSectionStart(10), sharedSectionEnd(15) {
}
...
void RailwaySystem::startSimulation(int numSteps) {
    ...
    std::cout << " You need to implement the startSimulation() method before testing it.\n";
    //Todo: Task 1 
